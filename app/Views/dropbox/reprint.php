...
$(document).ready(function(){
    ...
    function updateTableContent() {
        ...
        if (startDate || endDate){
            ...
            xhr.open('POST', 'reprint-json', true);
    ...
    function updateTable(data) {
        ...
        data.forEach(function(value) {
            table.row.add([
                ...
                value['user_generate'],
                value['company_name'],
                `<a href="<?= base_url()?>dropbox/pdf?dropbox_id=${value['dropbox_id']}" class="btn btn-info" role="button" aria-pressed="true">Print <i class="fa fa-print" aria-hidden="true"></i></a>`,
            ]).draw();
        });
        ...
        $('.btn-detail').click(function() {
            ...
            $.ajax({
            url: "<?= base_url()?>dropbox/dropbox-detail",
            method: "GET",
            dataType : 'json',
