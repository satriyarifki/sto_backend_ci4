...
$(document).ready(function(){
    ...
    function updateTableContent() {
        ...
        if (startDate || endDate){
            ...
            xhr.open('POST', 'npkp-reprint-json', true);
    ...
    function updateTable(data) {
        ...
        data.forEach(function(value) {
            table.row.add([
                ...
                value['company_name'],
                value['user_generate'],
                `<a href="<?= base_url()?>dropbox/pdfnpkp?dropbox_id=${value['dropbox_id']}" class="btn btn-info" role="button" aria-pressed="true">Print <i class="fa fa-print" aria-hidden="true"></i></a>`,
            ]).draw();
        });
        ...
        $('.btn-detail').click(function() {
            ...
            $.ajax({
            url: "<?= base_url()?>dropbox/npkp-dropbox-detail",
            method: "GET",
            dataType : 'json',
