...
<body class="d-flex flex-column min-vh-100">
      ...
      <div class="container">
          <div class="row align-items-center justify-content-between">
                  ...
                  <div class="swiper init-swiper">
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide">
                              <img src="<?= base_url('uploads/news/' . $news[0]['path_image']) ?>" alt="<?= $news[0]['title'] ?>" class="img-fluid">
                          </div>
                      </div>
              ...
              <div class="col-lg-4 order-lg-1">
                  <h1 class="mb-4" data-aos="fade-up"><?= $news[0]['title'] ?></h1>
                  <p data-aos="fade-up">
                    Kepada Yth. Vendor MAJ,
                  </p>
                  <p data-aos="fade-up"><?= $news[0]['content'] ?></p>
                  <p data-aos="fade-up">
  ...
  <section id="expandable-card" class="section">
      <div class="container">
          <div class="row">
                  ...
                  <div class="col-lg-12" data-aos="fade-up">
                      <div class="card mb-4">
                          <div class="card-header">
                              <h5 class="mb-0">
                                  <a data-bs-toggle="collapse" href="#collapseContent-<?= $item['id'] ?>" role="button" aria-expanded="false" aria-controls="collapseContent-<?= $item['id'] ?>">
                                      <?= $item['title'] ?>
                                  </a>
                              </h5>
                          </div>
                          <div id="collapseContent-<?= $item['id'] ?>" class="collapse">
                              <div class="card-body">
                                  <p><?= $item['content'] ?></p>
                                  <a href="<?= base_url('dashboard/news/detail/' . $item['id']) ?>" class="btn btn-info">Detail</a>
                              </div>
                          </div>
                      </div>
                  </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-md-4 text-center text-md-end">
          <img src="<?= base_url()?>img/MAJ-LOGO-3.png" alt="armada.ico" height="50">
        </div>
      </div>
    </div>
  </footer>
