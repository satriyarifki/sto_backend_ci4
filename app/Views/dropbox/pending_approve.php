...
<script>
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            "ajax": '<?= base_url()?>exception/get-exception-document',
            "columns": [
                { "data": "no_invoice" },
                { "data": "invoicing_id" },
                { "data": "company_name" },
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        if (data === 'Y') {
                            return '<button class="btn-update btn btn-danger btn-cancel" data-action="cancel" data-dropbox-id="' + row.no_invoice + '">Cancel Approve</button>';
                        } else {
                ...
                },
                {
                    ...
                    "orderable": false,
                    "render": function(data, type, row) {
                        let buttons = `<a href="<?= base_url()?>report/view-pdf?file=${row.file_path}" class="btn btn-info" target="_blank"><i class="fa fa-eye"></i> Faktur Pajak</a> 
                                    <a href="<?= base_url()?>report/view-pdf-invoice?file=${row.file_path_invoice}" class="btn btn-secondary" target="_blank"><i class="fa fa-eye"></i> Invoice</a>`;
                        
                        if (row.file_rev_path) {
                            buttons += ` <a href="<?= base_url()?>report/view-pdf-faktur-pengganti?file=${row.file_rev_path}" class="btn btn-warning" target="_blank"><i class="fa fa-eye"></i> Faktur Pengganti</a>`;
                        }
                        return buttons;
                    }
                }
